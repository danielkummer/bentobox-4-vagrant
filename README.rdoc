...
Just create a new client on the chef server (important: the client must be admin) and place the private key file (.pem) in the location specified by app_config.yml.
